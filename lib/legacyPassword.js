 ...
 * and it stops accepting the default. `bot_sessions_active` lists exactly which
 * numbers still don't have one. Setting LEGACY_DEFAULT_PASSWORDS to an empty
 * string disables the fallback entirely, which is the correct end state.
 */
